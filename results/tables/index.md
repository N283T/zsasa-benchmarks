...
| `batch_thread_scaling.csv` | 63 | Batch runtime, throughput, RSS, speedup, and efficiency across thread counts. |
...
| `runs_long.csv` | 1285 | One row per benchmark run with raw hyperfine-style statistics and common derived metrics. |
