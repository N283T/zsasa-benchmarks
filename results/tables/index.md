...
| --- | ---: | --- |
| `batch_t10_summary.csv` | 27 | 10-thread batch performance table, including runtime/RSS ratios versus comparators. |
| `batch_thread_scaling.csv` | 79 | Batch runtime, throughput, RSS, speedup, and efficiency across thread counts. |
| `best_by_context.csv` | 69 | Fastest/highest-throughput/lowest-RSS winners by benchmark context. |
| `comparator_ratios.csv` | 510 | Long-format runtime and RSS ratios used by the comparator-ratio figures. |
