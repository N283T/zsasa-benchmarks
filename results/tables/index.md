...
| `batch_thread_scaling.csv` | 59 | Batch runtime, throughput, RSS, speedup, and efficiency across thread counts. |
| `best_by_context.csv` | 45 | Fastest/highest-throughput/lowest-RSS winners by benchmark context. |
| `comparator_ratios.csv` | 266 | Long-format runtime and RSS ratios used by the comparator-ratio figures. |
...
| `runs_long.csv` | 385 | One row per benchmark run with raw hyperfine-style statistics and common derived metrics. |
